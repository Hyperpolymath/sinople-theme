...
:experimental:
:url-github: https://github.com/hyperpolymath/sinople-theme
:url-gitlab: https://gitlab.com/hyperpolymath/sinople-theme
:url-bitbucket: https://bitbucket.org/hyperpolymath/sinople-theme
:url-codeberg: https://codeberg.org/hyperpolymath/sinople-theme

Sinople (green) WordPress theme
...
sinople-theme is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
